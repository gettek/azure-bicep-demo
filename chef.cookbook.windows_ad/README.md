# windows_ad Cookbook
Library Repo Here: https://github.com/TAMUArch/cookbook.windows_ad
...
* test with `chef-client --local-mode --override-runlist cookbook.windows_ad` will run **[recipes/default.rb](recipes/default.rb)**
